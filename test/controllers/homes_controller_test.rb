...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { body: @home.body, link: @home.link, title: @home.title } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { body: @home.body, link: @home.link, title: @home.title } }
